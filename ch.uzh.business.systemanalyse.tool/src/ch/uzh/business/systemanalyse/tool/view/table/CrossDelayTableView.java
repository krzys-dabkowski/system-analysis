...
import ch.uzh.business.systemanalyse.tool.table.crossdelay.CrossDelayTableLabelProvider;
import ch.uzh.business.systemanalyse.tool.table.crossdelay.CrossDelayTableModelProvider;

/**
 * @author Krzysztof Dabkowski
 *
 */
public class CrossDelayTableView extends AbstractTableView {

	public static final String ID = "ch.uzh.business.systemanalyse.tool.views.crossdelaytableview";
	...
	public void init(IViewSite site) throws PartInitException {
		ModelProvider.INSTANCE.generateShortestPathsDelay();
		super.init(site);
	}*/
	...
	protected AbstractTableModelProvider createModelProvider() {
		return new CrossDelayTableModelProvider();
	}
	...
	protected AbstractTableLabelProvider createLabelProvider() {
		return new CrossDelayTableLabelProvider(viewer);
	}
